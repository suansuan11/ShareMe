...
- [x] **Step 4: Register sources and test target, then verify GREEN**
...
- [x] **Step 1: Write failing source and lifecycle contract tests**
...
- [x] **Step 3: Route late runtime errors into the policy**
...
- [x] **Step 4: Execute attempts on one owned timer**
...
- [x] **Step 5: Preserve shutdown and probe causality**
...
- [x] **Step 1: Write failing QML and application-status tests**
...
- [x] **Step 4: Strengthen smoke classification**
...
- [x] **Step 1: Configure and run regression gates**
...
- [x] **Step 2: Run native controlled recovery**
