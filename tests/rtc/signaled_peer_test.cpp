...
int main() {
  ...
  shareme::rtc::SignaledMediaStats empty_media_stats;
  REQUIRE(!empty_media_stats.local_audio_level);
  REQUIRE(!empty_media_stats.voice_packets_lost);
  REQUIRE(!empty_media_stats.voice_jitter_ms);
  REQUIRE(!empty_media_stats.voice_concealed_samples);
  REQUIRE(!empty_media_stats.voice_total_samples_received);
  ...
  const auto host_media_stats = send_only_host->media_stats();
  const auto viewer_media_stats = receive_only_viewer->media_stats();
  REQUIRE(!host_media_stats.unavailable);
  REQUIRE(host_media_stats.frames_encoded.has_value());
  REQUIRE(*host_media_stats.frames_encoded > 0);
  REQUIRE(host_media_stats.voice_packets_sent.has_value());
  REQUIRE(*host_media_stats.voice_packets_sent > 0);
  REQUIRE(host_media_stats.voice_packets_received.has_value());
  REQUIRE(*host_media_stats.voice_packets_received > 0);
  REQUIRE(host_media_stats.voice_bytes_sent.has_value());
  REQUIRE(*host_media_stats.voice_bytes_sent > 0);
  REQUIRE(host_media_stats.voice_bytes_received.has_value());
  REQUIRE(*host_media_stats.voice_bytes_received > 0);
  REQUIRE(!viewer_media_stats.unavailable);
  REQUIRE(viewer_media_stats.frames_received.has_value());
  REQUIRE(*viewer_media_stats.frames_received > 0);
  REQUIRE(viewer_media_stats.frames_decoded.has_value());
  REQUIRE(*viewer_media_stats.frames_decoded > 0);
  REQUIRE(viewer_media_stats.voice_packets_sent.has_value());
  REQUIRE(*viewer_media_stats.voice_packets_sent > 0);
  REQUIRE(viewer_media_stats.voice_packets_received.has_value());
  REQUIRE(*viewer_media_stats.voice_packets_received > 0);
  REQUIRE(viewer_media_stats.voice_bytes_sent.has_value());
  REQUIRE(*viewer_media_stats.voice_bytes_sent > 0);
  REQUIRE(viewer_media_stats.voice_bytes_received.has_value());
  REQUIRE(*viewer_media_stats.voice_bytes_received > 0);
  send_only_host->stop();
